...
{
    /* 获取分类列表 */
    $cat_list = cat_list(0, 0, false, 0, true, array());
...
if ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('cat_select',   cat_list(0, 0, true, 0, true, array()));
...
if ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('cat_select',  cat_list(0, $cat_info['parent_id'], true, 0, true, array()));
    $smarty->assign('goods_type_list',  goods_type_list(0)); // 取得商品类型
...
if ($_REQUEST['act'] == 'update')
{
    ...
    /* 判断上级目录是否合法 */
    $children = array_keys(cat_list($cat_id, 0, false, 0, true, array()));     // 获得当前分类的所有下级分类
